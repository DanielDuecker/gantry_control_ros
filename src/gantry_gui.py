...
rospy.init_node('gantry', anonymous=False )
...
class GantryControllerObj(object):
    ...
    def __init__(self):
        ...
        self.__gt = gantry_control.GantryControl([000, 3100, 000, 1600, 0, 500], use_gui, sdr_type)
...
class GantryGui(Tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.position_publisher=gantrycontroller.get_gt().get_ganty_publisher()
...
class StartPage(Tk.Frame):
    ...
    def get_position(self):
        ...
        #pub = rospy.Publisher('gantry_position_permanent', Gantry, queue_size=1)
        msg = Gantry()
        msg.header.stamp = rospy.Time.now()
        msg.header.frame_id = "global_tank"
        msg.position.x = pos_x_mm
        msg.position.y = pos_y_mm
        msg.position.z = pos_z_rad
